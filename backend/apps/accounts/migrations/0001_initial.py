    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('guest', 'Guest'), ('member', 'Member'), ('supplier', 'Supplier'), ('advertiser', 'Advertiser'), ('admin', 'Admin')], default='member', max_length=20)),
                ('corporate_email', models.EmailField(blank=True, max_length=254)),
                ('jeweller_id', models.CharField(blank=True, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_tier', models.CharField(default='Platinum', max_length=50)),
