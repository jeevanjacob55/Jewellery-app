...
from .views import (
    ...
    CompanyNotificationSubscriptionToggleView,
...
urlpatterns = [
    ...
    path(
        "companies/<int:company_id>/notification-subscription/",
        CompanyNotificationSubscriptionToggleView.as_view(),
        name="company_notification_subscription_toggle",
    ),
