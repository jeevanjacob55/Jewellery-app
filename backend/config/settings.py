...
env = environ.Env(
    ...
    MEDIA_PUBLIC_BUCKET_NAME=(str, ""),
    MEDIA_PRIVATE_BUCKET_NAME=(str, ""),
...
MEDIA_PUBLIC_BUCKET_NAME = env("MEDIA_PUBLIC_BUCKET_NAME", default=env("GCS_BUCKET_NAME", default=""))
MEDIA_PRIVATE_BUCKET_NAME = env("MEDIA_PRIVATE_BUCKET_NAME", default=env("GCS_PRIVATE_BUCKET_NAME", default=""))
MEDIA_PUBLIC_BASE_URL = env("MEDIA_PUBLIC_BASE_URL", default="").strip().rstrip("/")
GCS_BUCKET_NAME = MEDIA_PUBLIC_BUCKET_NAME
GCS_PRIVATE_BUCKET_NAME = MEDIA_PRIVATE_BUCKET_NAME
...
R2_ENDPOINT_URL = env("R2_ENDPOINT_URL", default="").strip()
R2_REGION = env("R2_REGION", default="auto").strip() or "auto"
...
GOOGLE_OAUTH_CLIENT_IDS = env("GOOGLE_OAUTH_CLIENT_IDS", default="").strip()
