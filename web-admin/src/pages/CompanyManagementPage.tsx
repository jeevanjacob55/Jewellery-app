...
export function CompanyManagementPage() {
    ...
    return (
      <section className="admin-placeholder">
        <div className="admin-placeholder__card">
          ...
          <h2 className="admin-placeholder__title">Company Management is only available to company admins.</h2>
          <p className="admin-placeholder__copy">Sign in with a scoped company-admin account to manage profile details and product listings.</p>
        </div>
      </section>
    );
  }
  ...
  if (!companyId || !detail) {
    return (
      <section className="admin-placeholder">
        <div className="admin-placeholder__card">
          <p className="admin-placeholder__eyebrow">Unavailable</p>
          <h2 className="admin-placeholder__title">No company is linked to this account.</h2>
          <p className="admin-placeholder__copy">This console needs a scoped company-admin user with a linked company record.</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="company-page">
      <div className="company-page__hero">
        <div>
          <p className="company-page__eyebrow">Company Admin</p>
          <h2 className="company-page__title">{detail.company.name}</h2>
          <p className="company-page__copy">
            Manage your public company profile, brand images, and product catalog from one place.
          </p>
          <div className="company-page__meta">
            <span>{detail.company.city}, {detail.company.state}</span>
            <span>{detail.company.tier.name}</span>
            <span>{detail.company.active_product_count} of {detail.company.tier.max_products} active products</span>
          </div>
        </div>
        ...
        <div className="company-page__status-grid">
          ...
          <div className="company-page__status-card">
            ...
            <strong>{detail.company.verification.gst_registered || detail.company.verification.bis_hallmarked || detail.company.verification.export_licensed ? "Verified" : "Unverified"}</strong>
          </div>
        </div>
      </div>
        ...
        <article className="company-card">
          ...
          <div className="company-form">
            ...
            <label className="rates-form__field">
              ...
              <input value={profileForm.daily_capacity ?? ""} onChange={(event) => setProfileForm((current) => ({ ...current, daily_capacity: event.target.value }))} />
            </label>
            <label className="rates-form__field">
              <span>Specialization</span>
              <input value={profileForm.specialization ?? ""} onChange={(event) => setProfileForm((current) => ({ ...current, specialization: event.target.value }))} />
            </label>
          </div>
          ...
          <div className="company-readonly-grid">
            ...
            <div className="company-readonly">
              ...
              <strong>{detail.company.tier.min_photos_per_product} to {detail.company.tier.max_photos_per_product}</strong>
            </div>
            <div className="company-readonly">
        ...
        <div className="company-modal-backdrop" role="presentation" onClick={closeProductEditor}>
          <div className="company-modal" role="dialog" aria-modal="true" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="company-form">
              ...
              <label className="rates-form__field">
                <span>Price</span>
                <input value={productForm.price} onChange={(event) => setProductForm((current) => ({ ...current, price: event.target.value }))} placeholder="Optional" />
              </label>
              <label className="rates-form__field company-form__field--full">
